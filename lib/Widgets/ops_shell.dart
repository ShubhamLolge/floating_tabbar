...
class _OpsShellState extends State<OpsShell> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        margin: EdgeInsets.all(platform == "Web Desktop" || platform == "Windows" || platform == "Web Tablet" ? 20 : 0),
        child: Material(
          elevation: widget.elevation,
          borderRadius: BorderRadius.circular(widget.radius),
          child: Container(
            height: (platform == "Web Desktop" || platform == "Windows" || platform == "Web Tablet" ? widget.height : size.height),
            width: (platform == "Web Desktop" || platform == "Windows" || platform == "Web Tablet" ? (widget.width ?? size.width * 0.35) : size.width),
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(platform == "Web Desktop" || platform == "Windows" || platform == "Web Tablet" ? widget.radius : 0),
            ),
            child: Center(
              child: ClipRRect(
                borderRadius: BorderRadius.circular(platform == "Web Desktop" || platform == "Windows" || platform == "Web Tablet" ? widget.radius : 0),
